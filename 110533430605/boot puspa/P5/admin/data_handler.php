							...
							if(!dlt){
								...
								$res = mysql_query($sql);
									...
									<?php
										...
										echo '<h3 class="text-center">Gagal Menghapus Data</h3>';
									}
								}else{
									show_admin_data($root);
								}
	...
	function data_editor($root, $id = 0){
		...
		if(isset($_POST['nim']) && $_POST['nim']){
			...
			if(!$id){
				...
				<?php
					...
					echo '<h3 class="text-center">Gagal menambah data</h3>';
				}
			}else{
				$nim = $_POST['nim'];
				$nama = $_POST['nama'];
				...
				<?php
					...
					echo '<h3 class="text-center">Gagal Memodifikasi</h3>';
				}
			}
		}
		...
		if ($view){
			...
			<form action="" method="post" class="form-horizontal">
                ...
                <div class="control-group">
                	<div class="controls">
                		<input type="submit" value="Submit" class="btn btn-primary" /><input type="button" value="Cancel" onclick="history.go(-1)" class="btn btn-primary" />
                	</div>
                </div>
			</form>
			<br />
